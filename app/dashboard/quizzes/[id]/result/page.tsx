...
const MOCK_LEADERBOARD = [
  ...
  { rank: 4, name: "You", score: 75, time: "3:00" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <main className="max-w-4xl mx-auto px-4 py-10">
        <div className="bg-linear-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white text-center shadow-xl mb-10">
          <Trophy className="w-16 h-16 mx-auto mb-4 text-yellow-300" />
          <h1 className="text-4xl font-extrabold mb-2">Quiz Completed!</h1>
          <p className="text-indigo-100 text-lg mb-6">
            You scored <span className="font-bold text-white text-2xl">75/100</span>
          </p>
        </div>
              ...
              {MOCK_LEADERBOARD.map((user) => (
                <tr
                  ...
                  className={`hover:bg-gray-50 dark:hover:bg-gray-700/30 ${
                    user.name === 'You' ? 'bg-indigo-50 dark:bg-indigo-900/10' : ''
                  }`}
                >
